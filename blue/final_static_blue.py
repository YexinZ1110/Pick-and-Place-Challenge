...
if __name__ == "__main__":
    ...
    dynamic_standy = [-0.08542891,  0.1200711, -0.11651164, -
                      1.34435869,  0.01400446, 1.46363719, 0.58579098]
    static_grabber.moveTo(dynamic_standy)

    # dynamic observation
    dynamic_standy = [-0.21864048156333393, 0.09752990275933435, -0.21548021523771294, -
                      1.3325246363135244, 0.02103608005673608, 1.4278474921749689, 0.3552714142426151]
    static_grabber.moveTo(dynamic_standy)
    # input("\nWaiting for start... Press ENTER to begin!\n")  # get set!
    ...
    static_standy = [ 0.1868097919104446 , 0.02237725159523426 , 0.13165936188987648 , -1.4150285313104967 , -0.0029628846950919855 , 1.437213937605845 , 1.1034403811863267 ]
    ...
    for ee_pose in ee_poses:
        ...
        q, rollout, success, message = ik.inverse(
            ee_pose, arm.get_positions(), "J_pseudo", 0.5)
